...
CCScene* Recipe14::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
    Recipe14 *layer = Recipe14::create();
...
bool Recipe14::init()
{
	...
	this->schedule(schedule_selector(Recipe14::gameLogic),3.0);
	this->scheduleUpdate();
	...
	CCMenuItemImage* pCloseItem = CCMenuItemImage::create(
		...
		this,
		menu_selector(Recipe14::menuCloseCallback));
...
//	this->addChild(pMenu);
	...
	CCMenuItemToggle* toggleItem =
		CCMenuItemToggle::createWithTarget(this,menu_selector(Recipe14::changeMode),menuItemOff,menuItemOn,NULL);
...
void Recipe14::addFood()
{
	...
	CCCallFuncN* actionMoveDone = CCCallFuncN::create(this,callfuncN_selector(Recipe14::spriteMoveFinished));
...
bool Recipe14::ccTouchBegan(CCTouch* touche,CCEvent* event)
{
...
void Recipe14::update(float dt)
{
	...
	CCRect foodRect = CCRectMake(
		...
		if(playerRect.intersectsRect(foodRect) && player->isVisible())
		{
			...
			this->scheduleOnce(schedule_selector(Recipe14::eat),0.1f);
		}
}
