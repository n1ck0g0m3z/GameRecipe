...
CCScene* Recipe16::scene()
{
    CCScene *scene = CCScene::create();
   
    Recipe16 *layer = Recipe16::create();
...
bool Recipe16::init()
{
	...
	this->schedule(schedule_selector(Recipe16::gameLogic),3.0);
	this->scheduleUpdate();
	...
	CCMenuItemImage* pCloseItem = CCMenuItemImage::create(
		...
		this,
		menu_selector(Recipe16::menuCloseCallback));
...
//	this->addChild(pMenu);
	...
	CCMenuItemToggle* toggleItem =
		CCMenuItemToggle::createWithTarget(this,menu_selector(Recipe16::changeMode),menuItemOff,menuItemOn,NULL);
...
void Recipe16::addFood()
{
	...
	CCCallFuncN* actionMoveDone = CCCallFuncN::create(this,callfuncN_selector(Recipe16::spriteMoveFinished));
...
bool Recipe16::ccTouchBegan(CCTouch* touche,CCEvent* event)
{
...
void Recipe16::update(float dt)
{
	...
	CCRect foodRect = CCRectMake(
		...
		if(playerRect.intersectsRect(foodRect) && player->isVisible())
		{
			...
			this->scheduleOnce(schedule_selector(Recipe16::eat),0.1f);
		}
}
