...
CCScene* Recipe17::scene()
{
    CCScene *scene = CCScene::create();
   
    Recipe17 *layer = Recipe17::create();
...
bool Recipe17::init()
{
	...
	this->schedule(schedule_selector(Recipe17::gameLogic),3.0);
	this->scheduleUpdate();
	...
	CCMenuItemImage* pCloseItem = CCMenuItemImage::create(
		...
		this,
		menu_selector(Recipe17::menuCloseCallback));
...
//	this->addChild(pMenu);
	...
	CCMenuItemToggle* toggleItem =
		CCMenuItemToggle::createWithTarget(this,menu_selector(Recipe17::changeMode),menuItemOff,menuItemOn,NULL);
...
void Recipe17::addFood()
{
	...
	CCCallFuncN* actionMoveDone = CCCallFuncN::create(this,callfuncN_selector(Recipe17::spriteMoveFinished));
...
bool Recipe17::ccTouchBegan(CCTouch* touche,CCEvent* event)
{
...
void Recipe17::update(float dt)
{
	...
	CCRect foodRect = CCRectMake(
		...
		if(playerRect.intersectsRect(foodRect) && player->isVisible())
		{
			...
			this->scheduleOnce(schedule_selector(Recipe17::eat),0.1f);
		}
}
