...
void Recipe15::addFood()
{
	...
	CCCallFuncN* actionMoveDone = CCCallFuncN::create(this,callfuncN_selector(Recipe15::spriteMoveFinished));
...
bool Recipe15::ccTouchBegan(CCTouch* touche,CCEvent* event)
{
